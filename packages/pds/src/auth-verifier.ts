...
> = {
  authorize: (
    ctx: MethodAuthContext<P, I> & { permissions: PermissionSet },
...
export class AuthVerifier {
  ...
  public accessAuthorization<P extends Params, I extends Input, R>(
    options: VerifiedOptions & ScopedOptions & AuthorizedOptions<P, I, R>,
  ): MethodAuthVerifier<AuthorizationOutput<R>, P, I> {
  ...
  public authorization<P extends Params, I extends Input, R>(
    options: VerifiedOptions &
      Partial<ScopedOptions> &
      AuthorizedOptions<P, I, R>,
  ): MethodAuthVerifier<AuthorizationOutput<R>, P, I>
  public authorization<P extends Params, I extends Input>(
    options?: VerifiedOptions &
      Partial<ScopedOptions> &
      Partial<AuthorizedOptions<P, I, void>>,
  ): MethodAuthVerifier<AuthorizationOutput<void>, P, I>
  ...
  public authorizationOrAdminTokenOptional<P extends Params, I extends Input>(
    ...
    I
  >
  public authorizationOrAdminTokenOptional<
    P extends Params,
    I extends Input,
    R,
  >(
    opts: VerifiedOptions & Partial<ScopedOptions> & AuthorizedOptions<P, I, R>,
  ): MethodAuthVerifier<
  ...
  public authorizationOrUserServiceAuth<P extends Params, I extends Input, R>(
    options: VerifiedOptions &
      Partial<ScopedOptions> &
      AuthorizedOptions<P, I, R>,
  ): MethodAuthVerifier<AuthorizationOutput<R>, P, I>
  public authorizationOrUserServiceAuth<P extends Params, I extends Input>(
    options?: VerifiedOptions &
      Partial<ScopedOptions> &
      Partial<AuthorizedOptions<P, I, void>>,
  ): MethodAuthVerifier<AuthorizationOutput<void>, P, I>
  ...
  public oauthAuthorization<P extends Params, I extends Input, R>(
    options: VerifiedOptions & AuthorizedOptions<P, I, R>,
  ): MethodAuthVerifier<AuthorizationOutput<R>, P, I>
  public oauthAuthorization<P extends Params, I extends Input>(
    options?: VerifiedOptions & Partial<AuthorizedOptions<P, I, void>>,
  ): MethodAuthVerifier<AuthorizationOutput<void>, P, I>
  public oauthAuthorization<P extends Params, I extends Input, R>(
    options: VerifiedOptions & Partial<AuthorizedOptions<P, I, R>> = {},
  ): MethodAuthVerifier<AuthorizationOutput<R>, P, I> {
  ...
  protected async verifyServiceJwt(
    ...
    return verifyServiceJwt(jwtStr, opts.aud, nsid, getSigningKey)
  }
}
